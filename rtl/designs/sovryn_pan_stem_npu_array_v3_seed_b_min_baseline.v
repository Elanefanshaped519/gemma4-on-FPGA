...
`include "sovryn_pan_stem_npu_array_v3_seed_b_min_issue.v"
`include "sovryn_pan_stem_npu_array_v3_seed_b_min_state.v"
`include "sovryn_pan_stem_npu_array_v3_seed_b_min_tile.v"

module sovryn_pan_stem_npu_array_v3_seed_b_min_top(
  input wire clk,
  input wire rst_n,
  ...
  wire [OBS_PACKET_WIDTH-1:0] tile_observe_payload;

  assign array_rows = ARRAY_ROWS[2:0];
  assign array_cols = ARRAY_COLS[2:0];

  sovryn_pan_stem_npu_array_v3_seed_b_min_tile #(
    .LOCAL_ROW(0),
    .LOCAL_COL(0)
  ) tile_inst (
    .clk(clk),

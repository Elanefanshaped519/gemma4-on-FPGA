...
`include "sovryn_pan_stem_npu_array_v4_seed_a_issue.v"
`include "sovryn_pan_stem_npu_array_v4_seed_a_state.v"
`include "sovryn_pan_stem_npu_array_v4_seed_a_tile.v"

module sovryn_pan_stem_npu_array_v4_seed_a_top(
  input wire clk,
  input wire rst_n,
  ...
  sovryn_pan_stem_npu_array_v4_seed_a_tile #(
    .LOCAL_ROW(0),
    .LOCAL_COL(0)
  ) tile_inst (
    .clk(clk),

...
`include "sovryn_pan_stem_npu_array_v2_innercore_a_issue.v"
`include "sovryn_pan_stem_npu_array_v2_innercore_a_execute.v"
`include "sovryn_pan_stem_npu_array_v2_innercore_a_retire.v"
`include "sovryn_pan_stem_npu_array_v2_innercore_a_observe.v"
`include "sovryn_pan_stem_npu_array_v2_innercore_a_tile.v"

module sovryn_pan_stem_npu_array_v2_innercore_a_top(
  input wire clk,
  input wire rst_n,
  ...
  generate
    for (row_index = 0; row_index < MAX_ROWS; row_index = row_index + 1) begin : row_gen
      for (col_index = 0; col_index < MAX_COLS; col_index = col_index + 1) begin : col_gen
        ...
        sovryn_pan_stem_npu_array_v2_innercore_a_tile #(
          .LOCAL_ROW(row_index),
          .LOCAL_COL(col_index),

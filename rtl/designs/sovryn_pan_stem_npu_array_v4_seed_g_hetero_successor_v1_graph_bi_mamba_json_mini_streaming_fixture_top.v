...
module sovryn_pan_stem_npu_array_v4_seed_g_hetero_successor_v1_graph_bi_mamba_json_mini_streaming_fixture_top(
  input wire clk,
  input wire rst_n,
  ...
  localparam integer ARRAY_COLS = 3;
  localparam integer TOTAL_TILE_SLOTS = 9;

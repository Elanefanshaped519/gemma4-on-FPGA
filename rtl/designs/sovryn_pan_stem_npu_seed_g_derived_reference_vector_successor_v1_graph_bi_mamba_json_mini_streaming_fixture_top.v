...
module sovryn_pan_stem_npu_seed_g_derived_reference_vector_successor_v1_graph_bi_mamba_json_mini_streaming_fixture_top(
  input wire clk,
  input wire rst_n,
  ...
  localparam integer MAX_PROJECTION_COMM_PRESSURE = 1;
  localparam integer MAX_EFFECTIVE_II = 6;

`include "sovryn_pan_stem_npu_array_observe_event_bit_readback.v"
`include "sovryn_pan_stem_npu_array_v4_seed_d_issue.v"
`include "sovryn_pan_stem_npu_array_v4_seed_d_state.v"
`include "sovryn_pan_stem_npu_array_v4_seed_d_tile.v"

module sovryn_pan_stem_npu_array_v4_seed_d_top(
  input wire clk,
  input wire rst_n,
  ...
  wire tile_observe_payload;

  assign array_rows = ARRAY_ROWS[2:0];
  assign array_cols = ARRAY_COLS[2:0];

  sovryn_pan_stem_npu_array_v4_seed_d_tile #(
    .LOCAL_ROW(0),
    .LOCAL_COL(0)
  ) tile_inst (
    .clk(clk),
  ...
  sovryn_pan_stem_npu_array_observe_event_bit_readback #(
    .MAX_COLS(1)
  ) observe_event_readback_inst (

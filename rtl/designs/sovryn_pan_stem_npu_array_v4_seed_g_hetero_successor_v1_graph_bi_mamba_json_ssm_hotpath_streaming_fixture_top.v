...
module sovryn_pan_stem_npu_array_v4_seed_g_hetero_successor_v1_graph_bi_mamba_json_ssm_hotpath_streaming_fixture_top(
  input wire clk,
  input wire rst_n,
  ...
  localparam integer ARRAY_COLS = 5;
  localparam integer TOTAL_TILE_SLOTS = 15;
  localparam integer PROJECTION_ROW = 0;
  localparam integer STATE_ROW = 1;
  localparam integer SFU_ROW = 2;
  localparam integer MAX_ALLOWED_HOPS = 2;
  localparam integer SEED_HOP_HEADROOM = 1;
  ...
  assign fanin_arbiter_required = 1'b1;

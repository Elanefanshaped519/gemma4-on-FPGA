module sovryn_pan_stem_npu_array_v2_innercore_a_tile #(
  ...
  wire execute_valid;
  wire [1:0] execute_opcode;
  wire [1:0] execute_addr;
  wire [15:0] execute_data;
  ...
  sovryn_pan_stem_npu_array_v2_innercore_a_issue #(
    .LOCAL_ROW(LOCAL_ROW),
    .LOCAL_COL(LOCAL_COL),
  ...
  sovryn_pan_stem_npu_array_v2_innercore_a_execute execute_inst (
    .clk(clk),
    .rst_n(rst_n),
    .issue_valid(issue_valid),
    .issue_opcode(issue_opcode),
  ...
  sovryn_pan_stem_npu_array_v2_innercore_a_retire retire_inst (
    .clk(clk),
    .rst_n(rst_n),
    .execute_valid(execute_valid),
    .execute_opcode(execute_opcode),
  ...
  sovryn_pan_stem_npu_array_v2_innercore_a_observe #(
